...
function keko_get_user( user )
    keko_hack = HTTPS.request("https://api.telegram.org/bot"..token.."/getChatMember?chat_id="..(database:get('keko:ch_username'..bot_id) or "@botlua").."&user_id="..user)
...
if res then
if res ~= "true" then
send(msg.chat_id_, msg.id_, 1, '• اهلا بك عزيزي 🔱 •\n• لايمكنك استخدام البوت ✅ •\n• عليك الاشتراك في القناة 🔽 •\n• ['..(database:get('keko:ch_username'..bot_id) or "@botlua")..'] ⚜️', 1, 'md')
return false end
end
...
send(msg.chat_id_, msg.id_, 1, "☑┇ تم تنزيل الشخص من جميع الرتب", 1, 'md')
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
--------------------------------------------------------------------------
...
if (text and text == "تعطيل الاعلانات"  and (is_creator(msg) or is_creatorbasic(msg))) then
...
if (text and text == "تفعيل الاعلانات"  and (is_creator(msg) or is_creatorbasic(msg))) then
...
🦁┇<a href="https://telegram.me/botlua">قناه السورس</a>
📜┇<a href="https://telegram.me/botlua">قناه شروحات سورس</a>
📁┇<a href="https://t.me/TSHAKETEAM">قناه ملفات السورس</a>

🔎┇<a href="https://t.me/botlua">طريقه التنصيب</a>

📮┇<a href="t.me/HHHHD">لـ تواصل </a>
]]
send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
end
